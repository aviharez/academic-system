      ...
      <?= form_open('admin/mata-kuliah/save') ?>
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            ...
            <?= (session()->getFlashdata('errorKdMk')) ? 'is-invalid' : '' ?>
            " name="kd_mk" placeholder="Masukkan Kode Mata Kuliah" autofocus>
            <?= (session()->getFlashdata('errorKdMk')) ? "<div class='invalid-feedback'>" . session()->getFlashData('errorKdMk') . "</div>" : ''; ?>
          </div>
        </div>
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            ...
            " name="nama_mk" placeholder="Masukkan Nama Mata Kuliah">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            ...
            " name="sks" placeholder="Masukkan Jumlah SKS">
